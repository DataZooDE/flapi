...
The image is pretty small and mainly contains the flAPI binary which is statically linked against [DuckDB v1.5.0](https://github.com/duckdb/duckdb/releases/tag/v1.5.0). Details about the docker image can be found in the [Dockerfile](./docker/development/Dockerfile).
